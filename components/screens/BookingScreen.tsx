    ...
    <div className="screen justify-between relative overflow-hidden">
      ...
      >
        <motion.div variants={item} className="flex items-center justify-between">
          <Image src="/logo.svg" alt="MEDfacials" width={120} height={36} />
          <span className="label-xs">Step 03 / 03</span>
        </motion.div>

        <motion.div variants={item} className="w-full h-px bg-brand-orange/10" />
        ...
        <motion.div variants={item} className="w-full space-y-0">
          ...
          {[
            ...
            <div
              key={code}
              className="flex items-start gap-3 py-3.5 border-b border-black/5 first:border-t"
            >
              <span className="font-sans text-[10px] font-semibold text-brand-orange/40 flex-shrink-0 pt-0.5">
                {code}
              </span>
              <span className="font-sans text-[13px] text-text-body leading-relaxed">
                {text}
              </span>
            </div>
          ))}
      ...
      >
        ...
        <button
          className="w-full font-sans text-[10px] text-text-light tracking-wider uppercase hover:text-text-body transition-colors py-2"
